...
**2. No Redis. No Celery.** Deliberate for a 250-visitor LAN event. Do not introduce
...
- Photo upload crops to the ID card aspect ratio before sending.
...
docker compose up -d                       # postgres only, no redis service
